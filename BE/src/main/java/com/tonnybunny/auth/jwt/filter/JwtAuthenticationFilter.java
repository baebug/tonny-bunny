package com.tonnybunny.auth.jwt.filter;
...
import com.tonnybunny.auth.PrincipalDetails;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	protected void successfulAuthentication(HttpServletRequest request,
		...
		//token 생성
		JwtToken jwtToken = jwtService.joinJwtToken(principalDetails.getUser().getEmail());
